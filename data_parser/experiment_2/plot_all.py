...
for machine in machines:
    for core_idx, core in enumerate(cores):
        ...
        figure.canvas.manager.set_window_title(cores_name[core_idx] + ' - ' + machine)
        ...
        for exe in execs:
            ...
            for exp in range(0, exe):
                ...
                with open(machine + '\\' + base_filename.format(core, exe, exp), newline='') as csvfile:
